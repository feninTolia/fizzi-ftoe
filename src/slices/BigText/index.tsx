...
const BigText = ({ slice }: BigTextProps): JSX.Element => {
  return (
    ...
    >
      <h2 className="grid w-full gap-[2vw] py-10 text-center font-black uppercase leading-[0.7]">
        <div className="text-[34vw]">Soda</div>
        <div className="grid justify-center gap-[2.5vw] text-[34vw] md:flex md:text-[11vw]">
